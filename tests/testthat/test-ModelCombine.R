test_that("Combine Models", {
  ...
  # write.csv(ases1, file = "mdl_combine_ases1.csv", row.names = FALSE)
  ases1_file = system.file("extdata", "mdl_combine_ases1.csv", package = "tswgewrapped", mustWork = TRUE)
  ...
  # write.csv(ases2, file = "mdl_combine_ases2.csv", row.names = FALSE)
  ases2_file = system.file("extdata", "mdl_combine_ases2.csv", package = "tswgewrapped", mustWork = TRUE)
  ...
  # write.csv(forecasts1, file = "mdl_combine_forecasts1.csv", row.names = FALSE)
  forecasts1_file = system.file("extdata", "mdl_combine_forecasts1.csv", package = "tswgewrapped", mustWork = TRUE)
  ...
  # write.csv(forecasts2, file = "mdl_combine_forecasts2.csv", row.names = FALSE)
  forecasts2_file = system.file("extdata", "mdl_combine_forecasts2.csv", package = "tswgewrapped", mustWork = TRUE)
  ...
  testthat::expect_equal(round(summary(comparison)[[1]][['Pr(>F)']][1],7), 0.5170811)
